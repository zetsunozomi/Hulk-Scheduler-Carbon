#!/usr/bin/env bash
# Sophia local launcher; ignored by Git. Based on scripts/cluster_stress.sh.
...
[[ $# -ge 6 ]] || { echo 'Usage: sophia_stress.sh CONFIG OUTPUT WAIT_MODEL CHECKPOINT VARIANT BETA [options]' >&2; exit 2; }
